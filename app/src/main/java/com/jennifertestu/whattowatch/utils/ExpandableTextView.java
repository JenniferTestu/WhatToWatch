        ...
        post(new Runnable()
        {
            public void run()
            {
                if (getLineCount()>MAX_LINES)
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.ic_keyboard_arrow_down_black_24dp);
                else
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.ic_keyboard_arrow_up_black_24dp);
